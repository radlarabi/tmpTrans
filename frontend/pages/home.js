...
export const home = async () => {
    ...
    document.title = "Ping Pong Jungle"
    ...
    const parallax = (e) => {
        ...
        layers.forEach((layer, i) => {
            const speed = (1 + i) * 0.5;
            const xDiff = (x * layer.dataset.speedx) / 100;
            const yDiff = (y * layer.dataset.speedx) / 100;
            
            layer.style.transform = `translateX(calc(-50% + ${xDiff}px)) translateY(calc(-50% + ${yDiff * 4}px))`;
            layer.style.transition = "all 0.15s ease-out";
        })
    }
    const stickyNavBar = (e) => {
        ...
        if (window.scrollY >= 450){
            ...
            document.getElementById("links").classList.replace("links", "stickyNavBar")
            ...
            document.getElementById("links").classList.replace("stickyNavBar", "links")
    ...
    window.addEventListener("resize", () => {
        if (window.innerWidth >= 1024 && document.getElementById("mobileMenu"))
    ...
    <nav class="nav" id="navBar">
        ...
        <div class="links" id="links">
            <div class="links-items"><a href="#game-section">Game</a></div>
            <div class="links-items"><a href="#chat-section">Chat</a></div>
            <div class="links-items"><a href="#team-section">Developers</a></div>
        </div>
        ...
        <div class="burger">
            <div class="burgerMenu" onclick="toggleBergerMenu()">
                <svg id="burgerSvg" width="40" height="40" viewBox="0 0 100 100" stroke="#9E94C9">
    ...
    <div class="mobileMenu" id="mobileMenu">
        <div class="links-mobile" id="links-mobile">
            <div class="links-mobile-items"><a href="#game-section">Game</a></div>
            <div class="links-mobile-items"><a href="#chat-section">Chat</a></div>
            <div class="links-mobile-items"><a href="#team-section">Developers</a></div>
            <a class="fancy" href="#">
                <span class="top-key"></span>
                <span class="text-login">Login</span>
                <span class="bottom-key-1"></span>
    ...
    <div class="hero-landing-page">
        <img src="assets/img/background.webp" class="parallax bg-img" data-speedx="3"/>


        <img src="assets/img/mountain_10.webp" class="parallax mountain_10" data-speedx="2.2"/>
        
        
        <img src="assets/img/mountain_9.webp" class="parallax mountain_9" data-speedx="2"/>
        
        <img src="assets/img/mountain_8.webp" class="parallax mountain_8" data-speedx="1.9"/>
        
        
        <img src="assets/img/mountain_7.webp" class="parallax mountain_7" data-speedx="3"/>
        
        <div class="text">
            <div class="box-shadow-text">Jungle Paddle </div>
            <div class="box-shadow-text">Ping Pong</div>
            <a href="#/login">
                <button class="jungleButton jungleButtonHome">Explore the game.
                    <div class="icon-1">
        ...
        <img src="assets/img/mountain_6.webp" class="parallax mountain_6" data-speedx="2"/>
        
       
        
        <img src="assets/img/mountain_5.webp" class="parallax mountain_5" data-speedx="2"/>
        
       
        
        <img src="assets/img/mountain_4.webp" class="parallax mountain_4" data-speedx="3"/>
        
        <img src="assets/img/mountain_3.webp" class="parallax mountain_3" data-speedx="2"/>
        
       
        
        <img src="assets/img/mountain_2.webp" class="parallax mountain_2" data-speedx="3"/>
        
        <img src="assets/img/mountain_1.webp" class="parallax mountain_1" data-speedx="2"/>
        
       
    
    </div>
    <div class="sec-section" id="game-section">
        <div class="game-description">
            <div class="game-text">
                <div class="game-text-title">
                    Discover the Adventure of Forest Ping Pong!
                </div>
                <div class="game-text-description">
                    Immerse yourself in an exciting and challenging ping pong experience set in the heart of a mystical forest. Our game combines fast-paced action with a tranquil, nature-inspired environment, perfect for both casual players and competitive enthusiast.
                </div>
                <div class="game-features" id="game-features">
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="game-feature-title">Engaging Gameplay</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="game-feature-title">Stunning Forest-Themed Graphics</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="game-feature-title">Multiplayer Mode</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="game-feature-title">Tournament Mode</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="game-feature-title">Customizable Avatars</div>
                    </div>
                </div>
                <a class="fancy play-now" href="#">
                    <span class="top-key"></span>
                    <span class="text-login">Play Now</span>
                    <span class="bottom-key-1"></span>
                    <span class="bottom-key-2"></span>
                </a>
            </div>
            <div class="game-asset">
                <img src="./assets/gifs/pingPongGif.gif"/>
            </div>
        </div>
    </div>
    <div class="third-section" id="chat-section">
        <div class="chat-description">
            <div class="chat-asset">
                <img src="./assets/gifs/chatGif.gif"/>
            </div>
            <div class="chat-text">
                <div class="chat-text-title">
                    Chat with Friends and Competitors
                </div>
                <div class="chat-text-description">
                    Stay connected with your friends and competitors through our in-game chat feature. Share tips, strategies, and even make new friends as you compete in thrilling ping pong matches.
                </div>
                <div class="chat-features">
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="chat-feature-title">Real-Time Chat</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="chat-feature-title">Customizable Avatars</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="chat-feature-title">Friend List</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="chat-feature-title">Private Messaging</div>
                    </div>
                    <div class="feature-item">
                        <img src="./assets/icons/check.svg" alt="check">
                        <div class="chat-feature-title">Group Chat</div>
                    </div>
                </div>
                <a class="fancy play-now" href="#">
                    <span class="top-key"></span>
    ...
    <div class="forth-section" id="team-section">
        <div class="team-cards">
            <div class="team-card">
                <div class="team-card-image">
                    <img src="https://cdn.intra.42.fr/users/91928f65e90a7ab7489be925389363f5/rlarabi.JPG"/>
                </div>
                <div class="team-card-text">
                    <div class="team-card-title">Radouan Larabi</div>
                    <div class="team-card-description">FrontEnd Developer</div>
                    <div class="team-card-links">
                        <a href="https://www.linkedin.com/in/radouan-larabi-7b1b3b1b1/" target="_blank">
                            <img src="./assets/icons/linkedin.svg" alt="linkedin" width="25px" heigth="25px">
                        </a>
                        <a href="https://www.linkedin.com/in/radouan-larabi-7b1b3b1b1/" target="_blank">
                            <img src="./assets/icons/linkedin.svg" alt="linkedin" width="25px" heigth="25px">
                        </a>
...
let isToggle = false;
window.toggleBergerMenu  = () => {
    const berger = document.getElementById("burgerSvg");
    isToggle ? berger.classList.remove("opened") : berger.classList.add("opened") 
    
    isToggle ?  document.body.style.overflow = 'auto' : document.body.style.overflow = 'hidden'
    
    document.getElementById("mobileMenu").style.display = isToggle ? "none" : "block"
    isToggle = !isToggle    
}
